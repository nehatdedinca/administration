# Starter Kit for [Building Applications in React and Redux in ES6](https://github.com/nehatdedinca/administration) on Pluralsight

## Get Started
1. **Install [Node 6](https://nodejs.org)**. Need to run multiple versions of Node? Use [nvm](https://github.com/creationix/nvm) or [nvm-windows](https://github.com/coreybutler/nvm-windows)
2. **Clone this repository.** - `git clone https://github.com/nehatdedinca/administration.git`
3. **Make sure you're in the directory you just created.** - `cd administration`
